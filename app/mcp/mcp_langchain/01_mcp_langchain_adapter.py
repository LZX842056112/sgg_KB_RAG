...
# 爆红因为需要安装 uv add langchain_mcp_adapters 依赖!!!!!!!
...
client = MultiServerMCPClient(
    {
        ...
        "amap-maps": {
            ...
            "url": "https://mcp.api-inference.modelscope.net/adf997d6b31349/mcp",
        ...
        "local-demo": {
            ...
            "args": [r"C:\Users\admin\PycharmProjects\langchain_demo\agent\mcp_stdio\01_mcp_stdio_server.py"],
